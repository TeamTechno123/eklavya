...
--
-- Host: localhost:3306
-- Generation Time: Feb 12, 2020 at 08:06 AM
...
--
ALTER TABLE `contact_mail`
  MODIFY `contact_mail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `gallery_photo`
  MODIFY `gallery_photo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
