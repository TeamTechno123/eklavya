                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-12 drop-lg">
                    <select class="form-control select2" name="notification_type" id="notification_type" title="Select Type" data-placeholder="Select Type" style="width: 100%;" required>
                      ...
                      <option <?php if(isset($notification_type) && $notification_type == 'Notification'){ echo 'selected'; } ?> >Notification </option>
                      <option <?php if(isset($notification_type) && $notification_type == 'Circulars'){ echo 'selected'; } ?> >Circulars</option>
                    </select>
                  </div>
