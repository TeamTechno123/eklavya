<section class="gallery-page" style="min-height: calc(100vh - 150px);">
  <div class="container">
    <div class="col-md-12">
      <h1 class="page-heading text-center">Non Teaching Staff</h1>
    </div>
    <div class="staff-div">
    <!-- <div class="row">
      <div class="col-md-3">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-center mb-0"><?php echo $list->staff_qualification; ?></p>
            <p class="card-text text-center"><?php echo $list->staff_possition; ?></p>
          </div>
        </div>
      </div>
    <?php } ?>
